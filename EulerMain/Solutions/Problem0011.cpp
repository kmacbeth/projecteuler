...
namespace Euler {
    ...
    void Problem11::Solve()
    {
        ...
        const uint32_t kLength = 4;
        const  int32_t kGridWidth = 20;
        const  int32_t kGridHeight = 20;
        ...
        {
            int32_t x = s % kGridWidth;
            int32_t y = s / kGridHeight;
            ...
            for(uint32_t d = 0; d < directions.size(); ++d)
            {
                 ...
                 // Compute product
                 uint32_t currentProduct = 1;

                 for(uint32_t n = 0; n < kLength; ++n)
                 {
                     currentProduct *= kGrid[y + directions[d].m_Y * n][x + directions[d].m_X * n];
                 }
